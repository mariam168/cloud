                    ...
                    >
                        ...
                        {slidesLength > 1 && (
                            ...
                            <div
                                ...
                                className={`absolute inset-0 z-10 flex items-center justify-between px-4 transition-opacity duration-300 ${hovered ? "opacity-100" : "opacity-0 md:opacity-100"
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center flex-1 text-center md:text-left transition-all duration-700 ease-out p-4 md:p-0">
                            ...
                            <div className="flex-1 ml-0 md:ml-8 p-4 md:p-6 lg:p-8 order-2 md:order-1">
                                ...
                                <Link to={currentSlideContent.link} className="inline-block">
