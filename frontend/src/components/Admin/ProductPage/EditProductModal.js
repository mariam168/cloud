...
const EditProductModal = ({ product, onClose, onProductUpdated, serverUrl }) => {
    ...
    const [editedProduct, setEditedProduct] = useState({ name_en: '', name_ar: '', description_en: '', description_ar: '', basePrice: '', category: '', subCategory: '' });
    ...
    const handleProductChange = (e) => {
        ...
        if (name === 'category') {
            setEditedProduct(prev => ({ ...prev, category: value, subCategory: '' }));
        } else {
                    ...
                    <Fieldset legend={t('productAdmin.basicInfo')}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                            ...
                            <Select 
                                ...
                                disabled={!selectedCategoryData?.subCategories?.length}
                            >
                                <option value="">{t('forms.select')}</option>
