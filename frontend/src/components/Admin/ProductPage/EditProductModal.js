...
import { X, PlusCircle, Trash2, Image as ImageIcon, UploadCloud, AlertCircle, Edit, ChevronsRight } from 'lucide-react';
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
            <div className="bg-white dark:bg-slate-900 p-2 sm:p-4 rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] flex flex-col border border-slate-700">
                ...
                <form id="edit-product-form" onSubmit={handleSubmit} className="flex-grow overflow-y-auto p-6 space-y-8 custom-scrollbar">
                    {errorMessage && (
                ...
                <footer className="flex-shrink-0 flex justify-end gap-4 p-4 mt-auto border-t border-gray-200 dark:border-slate-700">
                    ...
                    <button type="submit" form="edit-product-form" disabled={isSubmitting} className="px-6 py-2.5 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 disabled:bg-indigo-400 dark:disabled:bg-indigo-800 disabled:cursor-not-allowed transition-colors shadow-lg hover:shadow-indigo-500/30">
