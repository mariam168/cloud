...
const ProductDetails = () => {
    ...
    // --- تعديل جوهري: advertisement الآن جزء من حالة المنتج ---
    ...
    const fetchProductDetails = useCallback(async () => {
        ...
        try {
            ...
            setProduct(res.data); // البيانات الآن تحتوي على advertisement إذا وجد
    ...
    // --- تعديل جوهري: اشتقاق بيانات العرض مباشرة من المنتج ---
    ...
    // البيانات الآن مترجمة من الخادم
